...
img = cv2.imread('./images/castelo_01.jpeg')
#img = cv2.imread('./images/aviao_01.jpg')
...
edges_gray = cv2.Canny(image=img_gray, threshold1=a, threshold2=a)
...
img_copy = img.copy()
final = cv2.drawContours(img_copy, contours, contourIdx = 0,
                         color = (255, 0, 0), thickness = 2)


#plot imagens
imagens = [img,img_blur,img_gray,edges_gray,edges_blur,thresh,thresh_open,final]
formatoX = math.ceil(len(imagens)**.4)
